...
namespace Mrsteiger\Model;

use \Mrsteiger\DB\Sql;
use \Mrsteiger\Model;
use \Mrsteiger\Model\User;
...
class Cart extends Model {
	...
	public function getProducts() {
		...
		return Product::checkList( $sql->select("SELECT b.idproduct, b.desproduct, b.vlprice,
